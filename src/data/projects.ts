...
export const projects = [
    {
        ...
        description: 'A full-stack platform that enables users to build personalized wedding apps with real-time preview, Firebase integration, and ZIP download functionality.',
        tech: ['Flutter', 'Firebase', 'Node.js', 'Express', 'Java Spring Boot', 'Firestore'],
        url: "https://www.weddesigner.io"
    },
    {
        title: 'Just Collab',
